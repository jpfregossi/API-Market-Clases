    ...
    <div>
        ...
        <Form>
          ...
          <Duo>
            ...
            <Button onClick={() => handleClick("username")}>Cambiar usuario</Button>
          </Duo>
          {err ? <span style={{marginTop:"10px", color:"red"}}>Campo Vacio !</span> : <></>}
          <Duo>
            <Input placeholder={eml} onChange={(e) => setEmail(e.target.value)}/>
            <Button onClick={() => handleClick("email")}>Cambiar E-Mail</Button>
          </Duo>
          {err2 ? <span style={{marginTop:"10px", color:"red"}}>Campo Vacio !</span> : <></>}
          <Duo>
            <Input placeholder="New Password" onChange={(e) => setPassword(e.target.value)}/>
            <Button onClick={() => handleClick("password")}>Cambiar contraseña</Button>
          </Duo>
          {err3 ? <span style={{marginTop:"10px", color:"red"}}>Campo Vacio !</span> : <></>}
        </Form>
    </div>
  );
